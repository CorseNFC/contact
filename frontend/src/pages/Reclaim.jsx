  ...
  return (
    <div className="min-h-screen bg-slate-950 text-slate-100">
      ...
      <div className="pt-32 pb-24 max-w-md mx-auto px-4" data-testid="reclaim-page">
        ...
        <p className="mt-3 text-sm text-slate-400">L'ancien propriétaire a généré un code de transfert. Entrez-le avec votre email pour prendre possession de la carte.</p>

        <form onSubmit={submit} className="kt-card mt-8 p-6 space-y-4">
          <div>
            <Label className="text-xs text-slate-400 mb-1.5 block">Code de transfert</Label>
            <Input value={code} onChange={(e) => setCode(e.target.value.toUpperCase())} placeholder="XXXXXXXX" maxLength={8}
                   ...
                   className="bg-slate-900/60 border-white/10 focus:border-amber-400/60 text-slate-100 font-mono tracking-[0.3em] uppercase" />
          </div>
          <div>
